...
- Mirror production ownership and place coverage in the narrowest matching app, core, document, editor, workspace, design-system, architecture, integration, or performance boundary; see [the architecture](../docs/architecture.md).
