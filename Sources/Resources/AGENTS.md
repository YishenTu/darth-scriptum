...
- Keep renderer dependencies vendored and local.
...
- Update `scripts/vendor-checksums.sha256` with reviewed upstream files and run `scripts/check-vendored-resources.sh` after any bundle change.
