...
extension DocumentSyncReducer {
    ...
    static func saveAsAttached(
        ...
        guard let durableBaseline,
            identity.matches(url: url),
            durableBaseline.documentIdentity == identity
        else {
    ...
    private static func deferAttachmentTransition(
        ...
        updated.pendingAttachmentTransition =
            updated.pendingAttachmentTransition
    ...
    static func applyPendingAttachmentTransition(
        ...
        guard !state.local.hasUncancellableCommit,
            ...
            let pendingTransition = state.pendingAttachmentTransition
        else {
            return nil
        }
        var updated = state
    ...
    private static func replaceAttachment(
        ...
        let requiresExternalVerification =
            !attachmentIdentityMatchesURL
